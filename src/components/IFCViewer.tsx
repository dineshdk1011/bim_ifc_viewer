...
const DEFAULT_BUCKETS: Record<string, number> = {
  Walls: 100000001, // IFCWALL (more common)
  Slabs: 100000002, // IFCSLAB
  Doors: 100000003, // IFCDOOR
  Windows: 100000004, // IFCWINDOW
};
  ...
  useEffect(() => {
    ...
    const initializeViewer = async () => {
      try {
        ...
        // Set WASM path - ensure this path is correct for your setup
        ifcManager.setWasmPath("/wasm/");

        // Try to initialize WASM
        await ifcManager.init();
        ...
        setError(
          "Failed to initialize 3D viewer. Check browser console for details."
        );
      }
    };
